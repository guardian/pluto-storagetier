  ...
  "AssetSweeperNewFile.Decoder" should {
    "decode a sample message from asset sweeper" in {
      ...
      io.circe.parser
        ...
        false,
        "video/mp4",
        ZonedDateTime.of(2021,9,27,20,9,4,0, ZoneId.systemDefault()),
        ZonedDateTime.of(2021,9,29,9,32,29,647000000, ZoneId.systemDefault()),
        ZonedDateTime.of(2021,9,29,9,32,29,768000000, ZoneId.systemDefault()),
        501,
        423452,
        "zoom_0.mp4",
